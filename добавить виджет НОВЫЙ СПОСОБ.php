...
function bert_widgets_init() {
        ...
        $array_widgets = array(
                                                     ...
                                                     array('name' => 'Text (For "Pisza o nas")', 'id' => 'text_pisza_o_nas'),
                                                     array('name' => 'Text (Home)', 'id' => 'text_home'),
                                                     array('name' => 'Text (Home, in front of a picture)', 'id' => 'text_home_front'),
                                                     array('name' => 'Text (Under nasze suplementy)', 'id' => 'under_nasze_suplementy'),
                                        array('name' => 'Text (Under nasze rynki)', 'id' => 'under_nasze_rynki')
                                                  );
